...
public class NotificationFlowTests : IAsyncLifetime
{
    ...
    public async Task TodayNotifications_ReturnsOverdueAndTodayOnly_NotFuture()
    {
        ...
        var notifYesterday = new OnTimeCRM.Domain.Entities.Notification
        {
            UserId = auth.UserId,
            ClientId = clientId,
            Title = "Overdue",
        ...
        var notifToday = new OnTimeCRM.Domain.Entities.Notification
        {
            UserId = auth.UserId,
            ClientId = clientId,
            Title = "Today",
        ...
        var notifTomorrow = new OnTimeCRM.Domain.Entities.Notification
        {
            UserId = auth.UserId,
            ClientId = clientId,
            Title = "Future",
